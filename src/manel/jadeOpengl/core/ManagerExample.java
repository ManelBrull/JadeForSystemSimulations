...
public class ManagerExample extends Agent implements GLEventListener {
	   ...
	   private static String TITLE = "Manager Example";
	   ...
	   private String textureFileName = "images/trol/crate.png";
	   ...
	   public void init(GLAutoDrawable drawable) {
		   ...
		   try {
			   ...
			   texture = TextureIO.newTexture(is, false, textureFileType);
		   ...
		   System.out.println("Salgo de init");
	   }
